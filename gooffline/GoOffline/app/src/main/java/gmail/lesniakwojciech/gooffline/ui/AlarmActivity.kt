...
class AlarmActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.okButton.setOnTouchListener(delayHideTouchListener)
        ...
        binding.cancelButton.setOnTouchListener(delayHideTouchListener)
        ...
        binding.fullscreenContent.text =
            if (airplaneModeOn) getString(R.string.switch_airplane_mode_on) else getString(R.string.switch_airplane_mode_off)
    }
