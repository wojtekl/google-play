...
class Repository {
  ...
  public function updateSettings($schedule, $showVisits, $tenant) {
    $statement = $this -> sql -> prepare("UPDATE `SETTINGS` SET `SCHEDULE` = :schedule, `SHOWVISITS` = :showVisits WHERE `TENANT` = :tenant;");
