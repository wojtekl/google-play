        ...
        <tbody>
          {currentWeek.map((e, i) => {
            return <tr>
              ...
              <td>{e['notes']}</td>
              <td><button type="button" class="btn btn-sm btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#exampleModal" onClick={() => { setSelected(e['id']) }}>{t('label_edit')}</button></td>
            </tr>
          })}
        </tbody>
      </table>
